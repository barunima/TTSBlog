  	...
  	def create
  		...
  		respond_to do |format|
  			if @comment.save
				...
				format.html(@comment.errors.each)
				# format.html {redirect_to blog_post_path(id: @comment.blog_post_id, comment_error: @comment.errors), notice: 'Comment failed to post'}
			end
		end
